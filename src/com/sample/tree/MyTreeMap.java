        ...
        implements NavigableMap<K,V>, Cloneable, java.io.Serializable
{
    ...
    public transient Entry<K,V> root;//todo private
    ...
    public Collection<V> values() {
        Collection<V> vs = super.values();//values;
        if (vs == null) {
            vs = new Values();
//            values = vs;
        }
    ...
    public void printEntry(Entry<K, V> node, int level) {
        if (node == null) return;
        System.out.println(level+" \t "+node+" " + (node.color==RED?"R":" B") +(node.parent !=null ?" ^ "+node.parent.key:""));
        printEntry(node.left, level+1);
        printEntry(node.right, level+1);
    }
    ...
    private class SubMap extends AbstractMap<K,V>
        ...
        private Object readResolve() {
            return new AscendingSubMap<>(MyTreeMap.this,
    ...
    static final class Entry<K,V> implements Map.Entry<K,V> {
        ...
        public String toString() {
            return key + "=" + value;// +"  "+(color?"BLACK":"RED");
        }
    }
